...
class LeadsTest(unittest.TestCase):
    def setUp(self):
        ...
        self.payload=dict(name='<script>Alex</script>',company='Sample & Company',phone='+1 212 555 0123',work_email='alex@example.com',office_address='12 Example Street, Suite 5',channel='SMS',request_id=secrets.token_hex(16))
    def tearDown(self):
    ...
    def test_validation_and_origin(self):
        for field,value in [('company',''),('phone','123'),('work_email','bad'),('channel','Telegram'),('fax','bot'),('request_id','bad')]:
